...
Assert-Contains 'deploy\freqtrade.service' @('freqtradeorg/freqtrade:stable', '--memory=800m', '-p 127.0.0.1:8080:8080', 'ModelMacdMomentumActive30')
...
Assert-Contains 'deploy\research\FiveModelStrategies.py' @('class ModelEmaAdxTrend', 'class ModelBollingerRsiReversion', 'class ModelDonchianAtrBreakout', 'class ModelMacdMomentum', 'class ModelMacdMomentumLoose150', 'class ModelMacdMomentumActive28', 'class ModelSupertrendConsensus', 'return min(5.0, max_leverage)', 'timeframe = "15m"', 'stoploss = -0.03', '"0": 0.02')
...
Assert-Contains 'deploy\trade_learning.py' @('macd_momentum_long', 'macd_momentum_short', 'macd_loose_long', 'macd_loose_short', 'macd_active_long', 'macd_active_short', 'MACD 상향 교차', 'MACD 하향 교차')
