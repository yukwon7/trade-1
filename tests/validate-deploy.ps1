...
$requiredFiles = @(
  ...
  'deploy\research\FiveModelStrategies.py',
  'deploy\research\run-five-model-backtests.sh',
  'deploy\research\validate-winner.sh',
  'deploy\research\lookahead.config.json',
  'deploy\research\results\5x-holdout-summary.txt',
  'deploy\research\results\winner-lookahead.csv',
...
Assert-Contains 'deploy\freqtrade.service' @('freqtradeorg/freqtrade:stable', '--memory=800m', '-p 127.0.0.1:8080:8080', 'ModelRsi50MacdZero')
...
Assert-Contains 'deploy\research\FiveModelStrategies.py' @('class ModelEmaAdxTrend', 'class ModelBollingerRsiReversion', 'class ModelDonchianAtrBreakout', 'class ModelMacdMomentum', 'class ModelMacdMomentumLoose150', 'class ModelMacdMomentumActive28', 'class ModelMacdMomentumResponsive24', 'class ModelRsi50MacdZero', 'class ModelSupertrendConsensus', 'return min(5.0, max_leverage)', 'timeframe = "15m"', 'stoploss = -0.03', '"0": 0.02')
Assert-Contains 'deploy\research\run-five-model-backtests.sh' @('ModelEmaAdxTrend', 'ModelSupertrendConsensus', 'BACKTEST_RANGES', 'BACKTEST_FEE:-0.0002')
Assert-Contains 'deploy\research\validate-winner.sh' @('lookahead-analysis', 'ModelMacdMomentum', 'minimum-trade-amount', 'winner-lookahead.csv')
Assert-Contains 'deploy\research\lookahead.config.json' @('"price_side": "other"', '"use_order_book": true')
Assert-Contains 'deploy\config.json.template' @('"dry_run": true', '"db_url": "sqlite:////freqtrade/user_data/tradesv3.dryrun.sqlite"', '"trading_mode": "futures"', '"margin_mode": "isolated"', '"max_open_trades": 5', '"stake_amount": 100', '"timeframe": "5m"', '"force_entry_enable": true', 'BTC/USDT:USDT', 'ETH/USDT:USDT', 'SOL/USDT:USDT', 'BNB/USDT:USDT', 'XRP/USDT:USDT', 'DOGE/USDT:USDT', 'ADA/USDT:USDT', 'LINK/USDT:USDT', 'HYPE/USDT:USDT', 'ZEC/USDT:USDT', 'SUI/USDT:USDT', 'AVAX/USDT:USDT', '1000PEPE/USDT:USDT', '__API_PASSWORD__')
Assert-Contains 'deploy\backtest.config.json' @('"dry_run": true', '"trading_mode": "futures"', '"margin_mode": "isolated"', '"max_open_trades": 5', 'BTC/USDT:USDT', 'ETH/USDT:USDT', 'SOL/USDT:USDT', 'BNB/USDT:USDT', 'XRP/USDT:USDT', 'DOGE/USDT:USDT', 'ADA/USDT:USDT', 'LINK/USDT:USDT', 'HYPE/USDT:USDT', 'ZEC/USDT:USDT', 'SUI/USDT:USDT', 'AVAX/USDT:USDT', '1000PEPE/USDT:USDT')
...
Assert-Contains 'deploy\trade_learning.py' @('macd_momentum_long', 'macd_momentum_short', 'macd_loose_long', 'macd_loose_short', 'macd_active_long', 'macd_active_short', 'macd_responsive_long', 'macd_responsive_short', 'rsi50_macd_zero_long', 'rsi50_macd_zero_short', 'MACD 상향 교차', 'MACD 하향 교차')
...
Assert-Contains 'deploy\install-primary.sh' @('TRADE_API_PASSWORD_FILE', 'docker pull "$FREQTRADE_IMAGE"', 'show-config', 'list-strategies', 'systemctl reload caddy', 'trade-learning-sync.timer', 'trade-learning-review-daily.timer', 'trade-learning-review-weekly.timer', 'trade-learning-review-monthly.timer', 'trade_learning.py', 'sync_learning.py', 'review_learning.py', 'recover_journal_trades.py', 'set_telegram_commands.py', 'FiveModelStrategies.py', 'run-five-model-backtests.sh', 'validate-winner.sh')
