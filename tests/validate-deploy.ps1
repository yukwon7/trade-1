...
Assert-Contains 'deploy\config.json.template' @('"dry_run": true', '"db_url": "sqlite:////freqtrade/user_data/tradesv3.dryrun.sqlite"', '"trading_mode": "futures"', '"margin_mode": "isolated"', '"max_open_trades": 5', '"stake_amount": 100', '"timeframe": "5m"', '"force_entry_enable": true', 'BTC/USDT:USDT', 'ETH/USDT:USDT', 'SOL/USDT:USDT', 'BNB/USDT:USDT', 'XRP/USDT:USDT', 'DOGE/USDT:USDT', 'ADA/USDT:USDT', 'LINK/USDT:USDT', '__API_PASSWORD__')
Assert-Contains 'deploy\backtest.config.json' @('"dry_run": true', '"trading_mode": "futures"', '"margin_mode": "isolated"', '"max_open_trades": 5', 'BTC/USDT:USDT', 'ETH/USDT:USDT', 'SOL/USDT:USDT', 'BNB/USDT:USDT', 'XRP/USDT:USDT', 'DOGE/USDT:USDT', 'ADA/USDT:USDT', 'LINK/USDT:USDT')
